...
krish_image = face_recognition.load_image_file("flask_server/faces/obama.jpg")
krish_face_encoding = face_recognition.face_encodings(krish_image)[0]

# Load a second sample picture and learn how to recognize it.
bradley_image = face_recognition.load_image_file("flask_server/faces/William.jpg")
